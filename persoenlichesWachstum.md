...
In körperlichen oder verbalen Konfliktsituationen können wir gelassener bleiben, weil wir nicht von Reflexen, Ängsten, Wut oder anderen Emotionen gesteuert werden. Wir lernen im Training stressige Situationen kennen (Angriffe) und lernen damit umzugehen (Techniken). Durch das wiederholte Üben gehen die bewusst gewählten Reaktionen ins Körpergedächtnis und wir können so unbewusste Reaktionen wie die [Kampf-oder Flucht-Reaktion](https://de.wikipedia.org/wiki/Kampf-oder-Flucht-Reaktion){:target="_blank"} vermeiden. So bleiben wir auch in einer stressigen Situation körperlich und emotional zentrierter und entspannter. 
